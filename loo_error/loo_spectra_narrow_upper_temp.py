...
def spec_leave(L1HF_dir, L2HF_dir, l, n_optimization_restarts=20, num_processes=5):
    ...
    HF_inds_orig = [144, 145, 146, 168, 169, 170, 195]
...
L1HF_base = '../data/narrow/matter_power_564_Box1000_Part750_7_Box1000_Part3000' 
L2HF_base = '../data/narrow/matter_power_564_Box250_Part750_7_Box1000_Part3000' 
