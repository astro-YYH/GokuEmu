...
if __name__ == "__main__":
    ...
    if rank == 0:
        print("Number of processes:", comm.Get_size())
    ...
    ind_selected, loss = select_slices_redshifts(X, Y, len_slice=len_slice, n_select_slc=n_select_slc, beams=beams, n_optimization_restarts=n_optimization_restarts, print_all=print_all, comm=comm, rank=rank, size=comm.Get_size())
    ...
    if rank == 0:
        ...
        print("Time spent (min):", elapsed_time)
        if not print_all:
